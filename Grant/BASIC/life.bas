10 REM LIFE FOR GRANT SEARL COMPUTER 03/08/2025
...
90 IF H<4 THEN H=4
100 IF H>30 THEN H=30
110 G=0:A=0:P=0:W=W+1:H=H+1:D1=W+1:D2=W-1:K=0:DG=W*H+W:NG=DG
120 XM=W-1:YM=W*H-W:N=0
140 CS=42:CH=46:CO=79-32:R=1
...
230 M(NG+Y+X)=(K=-3)OR(K=-2 AND M(A)=-1)
